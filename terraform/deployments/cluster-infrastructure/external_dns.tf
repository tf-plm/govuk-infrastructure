...
locals {
  ...
  external_dns_zone_name            = trimsuffix("${var.external_dns_subdomain}.${var.tfe_outputs_root_dns_nonsensitive_values.external_root_zone_name}", ".")
}
...
resource "aws_route53_record" "cluster_public_ns_parent" {
  zone_id = var.tfe_outputs_root_dns_nonsensitive_values.external_root_zone_id
